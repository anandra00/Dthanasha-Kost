            ...
            <div class="bg-white p-8 rounded-3xl card-shadow border border-gray-50 min-h-[500px]">
                ...
                <form id="editMode" action="{{ route('penghuni.update-profile') }}" method="POST" class="space-y-6 hidden fade-in">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div><label class="block text-[11px] font-bold text-zinc-500 uppercase tracking-widest ml-1 mb-2">Email</label><input type="email" name="email" value="{{ $user->email ?? '' }}" class="w-full px-4 py-3 rounded-xl bg-zinc-50 border border-zinc-200 focus:outline-none focus:ring-2 focus:ring-[#334155] transition-all text-sm font-bold text-zinc-900"></div>
